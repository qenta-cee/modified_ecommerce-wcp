...
define('MODULE_PAYMENT_WCP_INVOICE_BILLING_COUNTRIES_TITLE', 'Erlaubte L&auml;nder Rechnung');
define('MODULE_PAYMENT_WCP_INVOICE_BILLING_COUNTRIES_DESC', 'Kommasepariert, z.B. AT,DE');

define('MODULE_PAYMENT_WCP_INVOICE_SHIPPING_COUNTRIES_TITLE', 'Erlaubte L&auml;nder Versand');
...
define('MODULE_PAYMENT_WCP_INVOICE_PAYOLUTION_TERMS_TITLE', 'payolution AGB');
...
define('MODULE_PAYMENT_WCP_INVOICE_CURRENCIES_TITLE', 'Akzeptierte W&auml;hrungen');
define('MODULE_PAYMENT_WCP_INVOICE_CURRENCIES_DESC', 'Kommasepariert, z.B. EUR,USD,CHF');

define('MODULE_PAYMENT_WCP_INVOICE_MIN_AGE_TITLE', 'Minimalalter des Konsumenten');
define('MODULE_PAYMENT_WCP_INVOICE_MIN_AGE_DESC', 'Nur f&uuml;r RatePay relevant.');
